# LAZ3RUS 
LAZ3RUS is a Python-enabled code for transforming a captured point cloud of a weld geometry in 3D through the use of a laser scanner into STL, STEP and meshed ABAQUS input files with FreeCAD for further analysis. 

The use of LAZ3RUS along with a specific description of the steps needed for geometry capture are covered in detail in the following JoVE publication: [Automatic Laser-based Geometry Capture for Finite Element Analysis of Weld Beads](https://app.jove.com/t/68654/automatic-laser-based-geometry-capture-for-finite-element-analysis)

## Citing LAZ3RUS
If you use LAZ3RUS in your research please cite the above publication and the code as: RC Laurence, MJ Roy& J Li. (2025). RCLaurence/LAZ3RUS: LAZ3RUS (v0.1). Zenodo. https://doi.org/10.5281/zenodo.15175021

## Installation 
### Prerequisites
Developed with [Python 12](https://www.python.org/downloads/release/python-3120/), [FreeCAD 1.0](https://www.freecad.org/downloads.php) is required.

### Version 
The current version of LAZ3RUS (1.1) can be run using the example Python script (automatic_bead_to_finite_element_mesh.py) with hard coded values for necessary fitting thresholds or through the GUI (GUI.py). 
...
First, settings must be identified the **Settings** button. This will allow the loading of the [settings.yaml](https://github.com/RCLaurence/LAZ3RUS/blob/main/settings.yaml) file. 
